...
<body>
<div class="form">
    <form modelAttribute="flight" action="/employee/flights/create" method="post">
        <!---------------------------------------------LOGIN FORM------------------------------------------------------->
        ...
        <p class="message">Number of seats:
            <input class="name" name="numberOfSeats" type="text" placeholder="seats"/>
        </p>
        <p class="message">Ticket price:
            <input class="name" name="price" type="text" placeholder="price"/>
        </p>
        <button>add</button>
